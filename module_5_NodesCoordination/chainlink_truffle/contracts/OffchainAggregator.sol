...
contract OffchainAggregator is Owned, OffchainAggregatorBilling, AggregatorV2V3Interface, TypeAndVersionInterface {
  ...
  bool public trackerEnabled = true;
    ...
    external
  {
    ...
    { // Check the report contents, and record the result
      ...
      int192 median;
      if (trackerEnabled) {
        median = getMostFrequentValue(r.observations, r.hotVars.threshold, currJob);
      } else {
        median = r.observations[r.observations.length/2];
      }
  ...
  function setTrackerEnabled(bool enabled)
  public
  onlyOwner()
  {
